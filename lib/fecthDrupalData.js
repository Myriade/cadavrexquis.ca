...
export const useFetchAllFilms = (initialData, isSearch) => {
	const [data, setData] = useState(null)
	const [isLoading, setIsLoading] = useState(true)
	const [error, setError] = useState(null)
	const [cacheIsUsable, setCacheIsUsable] = useState(null)
		
	const homeCacheValue = 'homeFilms'
	const homeCacheTime = 'homeTimestamp'
	const searchCacheValue = 'searchFilms'
	const searchCacheTime = 'searchTimestamp'
	const cacheValueKey = isSearch ? searchCacheValue : homeCacheValue
	const cacheTimeKey = isSearch ? searchCacheTime : homeCacheTime
	...
	const queryParams = isSearch ? searchQueryParams : homeQueryParams
